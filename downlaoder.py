...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Top form: URL and destination
        form = QtWidgets.QFormLayout()
        self.url_edit = QtWidgets.QLineEdit()
        self.url_edit.setPlaceholderText("https://example.com/path/to/directory/")
        form.addRow("URL (directory root):", self.url_edit)
    ...
    def load_preset(self):
        ...
        if not p:
            ...
            return
        # apply
        self.url_edit.setText(p.get("url", ""))
    ...
    def start_download(self):
        ...
        url = self.url_edit.text().strip()
        if not url:
            QtWidgets.QMessageBox.warning(self, "Missing URL", "Please enter the directory URL to download.")
            return
